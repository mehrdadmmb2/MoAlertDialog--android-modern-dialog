package omidi.mehrdad.moalertdialog;
...
public class MoAlertDialog {
    ...
    private void initViews() {
        dilog_title = dialog.findViewById(R.id.dilog_title);
        dialog_content = dialog.findViewById(R.id.dialog_content);
        dilog_back = dialog.findViewById(R.id.dilog_back1);
        dilog_back2 = dialog.findViewById(R.id.dilog_back2);
        bg = dialog.findViewById(R.id.bg);
        dilog_header = dialog.findViewById(R.id.dilog_header);
        diolg_icon = dialog.findViewById(R.id.diolg_icon);
        dilog_button = dialog.findViewById(R.id.dilog_button);
